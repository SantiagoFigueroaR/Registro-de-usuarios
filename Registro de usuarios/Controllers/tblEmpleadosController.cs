...
//santiago prueba
{
    public class tblEmpleadosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Apellido,Puesto,Edad,Email")] tblEmpleados tblEmpleados)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Apellido,Puesto,Edad,Email")] tblEmpleados tblEmpleados)
        {
            if (ModelState.IsValid)
            {
